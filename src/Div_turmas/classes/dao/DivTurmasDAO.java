 ...
 */
package Div_turmas.classes.dao;
...
public class DivTurmasDAO {
    ...
    public void insertCriaTurma(DivTurmas d){    
        try{  
                        ...
                        String sql = "INSERT INTO DIV_TURMA VALUES (DEFAULT,?,?,?,?,NULL,NULL,NULL,NULL)";
    ...
    //esta funcionado
public void insertCriaTurmaSegundoHorario(DivTurmas d){    
        try{  
                        Connection con;
                        PreparedStatement stm;
    ...
    public DivTurmas Select2(DivTurmas d,String nomeTurma){
        ...
        try{
            ...
            //SEGUNDODIA_SEMANA=?,SEGUNDOHORARIO_DIA=?
            if(rs.next()){
                ...
                d.setSegudoDia_semana(rs.getString("SEGUNDODIA_SEMANA"));
                d.setSegundoHorario_dia(rs.getTime("SEGUNDOHORARIO_DIA"));
    ...
    public void updateSegundoDia(DivTurmas d,String nomeTurma){
		...
		try{
			...
			String sql = "UPDATE DIV_TURMA SET NOME_TURMA=?,"
                                + " DIA_SEMANA=?, HORARIO_DIA=?, MODALIDADE=?,SEGUNDODIA_SEMANA=?,SEGUNDOHORARIO_DIA=?"
                                + " WHERE NOME_TURMA=? ";
			...
			ps.setTime(3, d.getHorario_dia() );
			ps.setString(4, d.getModalidade());
                        ps.setString(5, d.getSegudoDia_semana());
			ps.setTime(6, d.getSegundoHorario_dia());
                        /*
                        ps.setInt(7, d.getFk_prof_rp());
                        ps.setInt(8, d.getFk_aluno_ra());*/
