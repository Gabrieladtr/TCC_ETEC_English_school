 ...
 */
package Div_turmas.classes.modelagem;
...
public class DivTurmas {
    ...
    //FORMATA DATA - nao sei se vou continuar esse method aqui
     public Date formataData(String data) throws ParseException{
        ...
        return new Date(formatador.parse(data).getDate());
        /*UTILIDADE PUBLICA:
        Date date = new Date();
    ...
    public int getRa_Aluno0() {
        return ra_Aluno0;
    }

    public void setRa_Aluno0(int ra_Aluno0) {
        this.ra_Aluno0 = ra_Aluno0;
    }

    public String getNomeAluno0() {
        return nomeAluno0;
    }

    /*abaixo o campo para preencher com o RA do aluno*/
    public void setNomeAluno0(String nomeAluno0) {
        this.nomeAluno0 = nomeAluno0;
    }

    
    private int ra_verifica, ra_Aluno0, ra_aluno1, ra_aluno2, ra_aluno3, ra_aluno4, ra_aluno5, ra_aluno6;
    ...
    private String nomeProfessor,nomeAluno0, nomeAluno1, nomeAluno2, nomeAluno3, nomeAluno4, nomeAluno5, nomeAluno6;
    ...
    public String getSegudoDia_semana() {
        return segudoDia_semana;
    }

    public void setSegudoDia_semana(String segudoDia_semana) {
        this.segudoDia_semana = segudoDia_semana;
    }

    public Time getSegundoHorario_dia() {
        return SegundoHorario_dia;
    }
     ...
     */
    public void setSegundoHorario_dia(Time SegundoHorario_dia) {
        this.SegundoHorario_dia = SegundoHorario_dia;
    }

    /*AS NOVAS VARIAVEIS ESTAO AQUI!!*/
    private String nome_turma, dia_semana, modalidade, segudoDia_semana;
    
    private Time horario_dia, SegundoHorario_dia;
