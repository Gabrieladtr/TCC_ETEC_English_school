...
public class AtualizarTurmasGUI extends javax.swing.JInternalFrame  {
	...
	//-------------------------------------------------------SEGUNDA PARTE DO SUPER IF-------------------------------------------------------------------------------
                ...
                JOptionPane.showMessageDialog(null,"0 - Será inserido um novo aluno nesta mesma turma. "
                                                    + "yesProf_yesAluno");    
...
public void preencheTextFieldsComAlunos(DivTurmas d, String nomeTurma){
         ...
         if(dao.verificaEstado(d, nomeTurma).equals("notProf_notAluno")){  
             ...
             String sql = "SELECT DISTINCT * FROM DIV_TURMA INNER JOIN CADASTRO_PROF ON (DIV_TURMA.FK_PROF_RP = CADASTRO_PROF.RP) "
                ...
                ResultSet rs = stm.executeQuery();
                    ...
                    /*Se os campos do objeto estiverem fora do if, ele repete a textFields. 
                    Se estiver dentro do if, nao mostra.
                    */
                    ...
                    //nos vamos rabalhar com outras variaveis
                    
                    d1.setNomeAluno1(d.getNomeAluno1());
                    d1.setRa_aluno1(d.getRa_aluno1());
                    
                    /*d1.setNomeAluno2(d.getNomeAluno2());
                    d1.setRa_aluno2(d.getRa_aluno2());   
                    
                    d1.setNomeAluno3(d.getNomeAluno3());
                    d1.setRa_aluno3(d.getRa_aluno3());
                    
                    d1.setNomeAluno4(d.getNomeAluno4()); 
                    d1.setRa_aluno4(d.getRa_aluno4());
                    
                    d1.setNomeAluno5(d.getNomeAluno5());
                    d1.setRa_aluno5(d.getRa_aluno5());
                    
                    d1.setNomeAluno6(d.getNomeAluno6());
                    d1.setRa_aluno6(d.getRa_aluno6());*/
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jTextField7_aluno6))
                            .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(jPanel6Layout.createSequentialGroup()
                                    .addComponent(jLabel24, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(18, 18, 18)
                                    .addComponent(jTextField6_aluno5))
                                .addGroup(jPanel6Layout.createSequentialGroup()
                                    .addComponent(jLabel22, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(18, 18, 18)
                                    .addComponent(jTextField5_aluno4))
                                .addGroup(jPanel6Layout.createSequentialGroup()
                                    .addComponent(jLabel20, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(18, 18, 18)
                                    .addComponent(jTextField4_aluno3))
                                .addGroup(jPanel6Layout.createSequentialGroup()
                                    .addComponent(jLabel18, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(18, 18, 18)
                                    .addComponent(jTextField3_aluno2))
                                .addGroup(jPanel6Layout.createSequentialGroup()
                                    .addComponent(jLabel15, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(18, 18, 18)
                                    .addComponent(jTextField2_aluno1, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGap(300, 300, 300)
    ...
    private void jButton3_buscar_turmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3_buscar_turmaActionPerformed
        ...
        //o item acima vai o botao de atualizacao        
        ...
        //precisamos de um metodo que preenche todas as textFields com seus respectivos valores.
    ...
    if(rbAluno1.isSelected()){
        try{
            ...
            PreparedStatement stm = null;
            con = UtilDAO.conectar();
            String sql = "UPDATE DIV_TURMA SET DIV_TURMA.FK_ALUNO_RA = NULL WHERE DIV_TURMA.FK_ALUNO_RA IN (?)";
            stm = con.prepareStatement(sql);
    ...
    if(rbAluno2.isSelected()){
         try{
            ...
            PreparedStatement stm = null;
            con = UtilDAO.conectar();
            String sql = "UPDATE DIV_TURMA SET DIV_TURMA.FK_ALUNO_RA = NULL WHERE DIV_TURMA.FK_ALUNO_RA = ?";
